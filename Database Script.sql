...
update users set password = md5('12345678') where username = "amansingh";
...
insert into Node (deviceID, username, field_name, temperature, humidity, moisture, light)
values('ARMS22212', 'amansingh', 'Samy Garden', 45, 54, 100, 600);
...
select * from users where username = "amansingh";
update users set last_login = now() where username = "amansingh";
